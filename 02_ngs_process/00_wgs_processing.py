...
def run_main(args):
  ...
  if args.fastq_R2 is not None:#paired-end
    ...
    #genome alignment
    cmd = bwa + " -r1 " + args.fastq_R1 + "_1_trimmed.fastq" + "_1_repair.fq.gz" + " -r2 " + args.fastq_R2 + "_2_trimmed.fastq" + "_2_repair.fq.gz " + " -index ./ref/hg19.fa.gz -sample " + sampleid 
    os.system(cmd)
    ...
    #genome alignment
    cmd = bwa + " -r1 " + args.fastq_R1 + "_1_trimmed.fastq" + " -index ./ref/hg19.fa.gz -sample " + sampleid  
    os.system(cmd)
